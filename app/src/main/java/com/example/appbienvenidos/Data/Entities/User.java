...
public class User {
    ...
    public User(String Last_Name , String First_Name, String Email ,
                String Password , String Location , String Profile_Picture_URL,
                String Bio , String Role , String Registration_Date){

        this.Last_Nom = Last_Name ;
    ...
    public String getLast_Nom() {
        return Last_Nom;
    }

    public void setLast_Nom(String last_Nom) {
        Last_Nom = last_Nom;
    }
